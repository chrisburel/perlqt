...
sub chooseSource
{
    this->chooseImage(this->tr('Choose Source Image'), this->sourceImage, this->sourceButton);
}
# [6]
...
{
    this->chooseImage(this->tr('Choose Destination Image'), this->destinationImage,
